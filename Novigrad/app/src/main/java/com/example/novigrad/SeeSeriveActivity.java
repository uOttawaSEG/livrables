...
public class SeeSeriveActivity extends AppCompatActivity {
    ...
    private  void update(String servceId, String serviceName, String Documents, String Formulaire)
    {
        ...
        final EditText formul = (EditText) dialogView.findViewById( R.id.formulairesmultiline );
        final EditText docum = (EditText) dialogView.findViewById( R.id.documentsmultiline );
        final TextView freq = (TextView) dialogView.findViewById( R.id.Formulaire );
        final TextView dreq = (TextView) dialogView.findViewById( R.id.documents );
    ...
    private  boolean updateservie(String id, String name, String documents,String formulaire)
    {
        ...
        Toast.makeText( SeeSeriveActivity.this,"Update succesful",Toast.LENGTH_LONG ).show();
        return true ;
    }
    @Override
