...
public class PortailAdministrateur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ModifierServices = (Button)findViewById(R.id.btnSuppressionServices);
        ...
        ModifierServices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent modiIntent = new Intent(PortailAdministrateur.this,ModifierLesServices.class);
        ...
        gererClient.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(PortailAdministrateur.this,ListesDesServices.class);
                startActivity(in);
            }
        });
